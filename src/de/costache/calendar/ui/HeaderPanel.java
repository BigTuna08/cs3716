...
public class HeaderPanel extends JPanel {
	...
	private void init() {
		...
		String strDay = "Day";//ResourceBundle.getBundle("calendar", getLocale()).getString("day");
		String strWeek = "Week";//ResourceBundle.getBundle("calendar", getLocale()).getString("week");
		String strMonth = "Month";//ResourceBundle.getBundle("calendar", getLocale()).getString("month");
